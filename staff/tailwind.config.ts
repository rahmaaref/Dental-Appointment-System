  ...
  theme: {
    ...
    extend: {
      ...
      backgroundImage: {
        ...
        'gradient-mesh': 'linear-gradient(135deg, var(--mint-light) 0%, var(--background) 40%, var(--mint) 100%)',
      ...
      boxShadow: {
        'neon': '0 0 30px rgba(var(--teal-neon), 0.5)',
        'neon-sm': '0 0 10px rgba(var(--teal-neon), 0.3)',
        'neon-lg': '0 0 50px rgba(var(--teal-neon), 0.6)',
